...
import { ITargets } from "./utils/dragOrClickHelper";
...
export declare class MatrixDynamicValueGetterContext extends QuestionValueGetterContext {
...
export declare class QuestionMatrixDynamicModel extends QuestionMatrixDropdownModelBase implements IMatrixDropdownData {
    ...
    startDragMatrixRow: (event: PointerEvent, targets: ITargets) => void;
    getType(): string;
    ...
    addRowByIndex(rowData: any, toIndex: number): void;
    removeRowByIndex(fromIndex: number): void;
    clearOnDrop(): void;
    initDataUI(): void;
    /**
     ...
     * Default value: `false`
     */
    get allowRowReorder(): boolean;
    set allowRowReorder(val: boolean);
    /**
    ...
    private fillSingleInputQuestionsByRow;
    ...
    protected getSingleInputTitleTemplate(): string;
    /**
     ...
     * @see addRowText
     */
    get addRowButtonLocation(): string;
    set addRowButtonLocation(val: string);
    /**
     ...
     */
    get noRowsText(): string;
    set noRowsText(val: string);
    get locNoRowsText(): LocalizableString;
    get locEditRowText(): LocalizableString;
    /**
