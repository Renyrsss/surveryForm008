...
import { IConfirmDialogOptions } from "./utils/utils";
...
export interface IBeforeRequestChoicesOptions {
...
export declare var settings: {
    ...
    expressionVariables: {
        ...
        parentPanel: string;
        panelIndex: string;
        visiblePanelIndex: string;
        unwrapPostfix: string;
    };
    /**
    ...
    showDefaultItemsInCreator: boolean;
    /**
