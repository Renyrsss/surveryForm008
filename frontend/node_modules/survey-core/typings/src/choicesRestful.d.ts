...
import { IBeforeRequestChoicesOptions } from "./settings";
...
export declare class ChoicesRestful extends Base {
    ...
    static get onBeforeSendRequest(): (sender: ChoicesRestful, options: IBeforeRequestChoicesOptions) => void;
    static set onBeforeSendRequest(val: (sender: ChoicesRestful, options: IBeforeRequestChoicesOptions) => void);
    ...
    protected sendXmlHttpRequest(): void;
    protected sendFetchRequest(): void;
    getType(): string;
    get isEmpty(): boolean;
    dispose(): void;
     ...
     * ```
     */
    get attachData(): boolean;
    set attachData(val: boolean);
