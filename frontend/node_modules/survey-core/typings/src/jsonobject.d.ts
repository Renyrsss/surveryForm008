...
export declare class JsonObjectProperty implements IObject, IJsonPropertyInfo {
    ...
    getSerializableValue(obj: any, storeDefaults?: boolean, options?: ISaveToJSONOptions): any;
    getValue(obj: any, options?: ISaveToJSONOptions): any;
...
export declare class JsonMetadata {
    ...
    getDynamicPropertiesByTypes(objType: string, dynamicType: string, nonSerialableProps?: Array<string>): Array<JsonObjectProperty>;
    private canAddDynamicProp;
...
export declare class JsonObject {
    ...
    private isProretyCanBeStoredByOptions;
    private valueToJsonCore;
    private reduceLocaleArray;
