...
export declare function getLocaleString(strName: string, locale?: string): string;
export declare function getLocaleStrings(locale: string): any;
...
export declare var surveyStrings: {
    ...
    buttongroupOptionsCaption: string;
    value: string;
    ...
    removeRow: string;
    noRowsText: string;
    rowIndexTemplateTitle: string;
    rowNameTemplateTitle: string;
    addPanel: string;
    removePanel: string;
    showDetails: string;
    hideDetails: string;
