...
import { ActionBarCssClasses } from "./container";
...
export declare abstract class BaseAction extends Base implements IAction {
    ...
    protected setId(val: string): void;
    iconName: string;
    iconSize: number | string;
    markerIconName: string;
    css?: string;
    minDimension: number;
    maxDimension: number;
    addVisibilityChangedCallback(callback: (action: BaseAction) => void): void;
    removeVisibilityChangedCallback(callback: (action: BaseAction) => void): void;
    ...
    get cssClasses(): Readonly<ActionBarCssClasses>;
...
export declare class Action extends BaseAction implements IAction, ILocalizableOwner {
    ...
    initLoadingIndicatorVisibilityObserver(handler: (isVisible: boolean) => void): void;
    dispose(): void;
    updateDimension(mode: actionModeType, htmlElement: HTMLElement, calcDimension: (el: HTMLElement) => number): void;
    needUpdateMaxDimension: boolean;
    needUpdateMinDimension: boolean;
    updateModeCallback: (mode: actionModeType, callback: (mode: actionModeType, el: HTMLElement) => void) => void;
    afterRenderCallback: () => void;
    afterRender(): void;
    updateMode(mode: actionModeType, callback: (mode: actionModeType, el: HTMLElement) => void): void;
    updateDimensions(calcDimension: (htmlElement: HTMLElement) => number, callback: () => void, modeToCalculate?: actionModeType): void;
}
