...
export declare var defaultCss: {
    ...
    question: {
        ...
        singleInputWrapper: string;
        breadcrumbsRoot: string;
        breadcrumbsItem: string;
        breadcrumbsItemButton: string;
        breadcrumbsSeparator: string;
        summary: string;
        summaryRow: string;
        summaryRowContent: string;
        summaryRowActions: string;
        summaryRowAction: string;
        summaryRowActionEdit: string;
        summaryRowActionDelete: string;
    };
    image: {
        mainRoot: string;
        root: string;
    ...
    boolean: {
        ...
        checkboxIsLabelRendered: string;
    ...
    slider: {
        root: string;
        rootSingleMode: string;
        rootNegativeScaleMode: string;
        rootDesignMode: string;
        rootAnimatedThumbMode: string;
        rootTooltipsAlwaysMode: string;
        rootLabelsShowValueTextMode: string;
        visualContainer: string;
        visualContainerSlider: string;
        rangeTrack: string;
        inverseTrackLeft: string;
        inverseTrackRight: string;
        thumbContainer: string;
        thumbContainerIndeterminateMode: string;
        thumbContainerFocusedMode: string;
        thumb: string;
        thumbDot: string;
        tooltip: string;
        tooltipPanel: string;
        tooltipOnHoverMode: string;
        tooltipValue: string;
        input: string;
    ...
    imagemap: {
        ...
        svg: string;
        svgItem: string;
        svgItemHovered: string;
        svgItemSelected: string;
        svgItemDisabled: string;
        svgControlPoint: string;
    };
};
