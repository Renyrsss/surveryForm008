 ...
 */
export declare class SurveyModel extends SurveyElementCore implements ISurvey, ISurveyData, ISurveyVariables, ISurveyDataGetEditingObj, ISurveyImpl, ISurveyTriggerOwner, ISurveyErrorOwner, ISurveyTimerText {
    ...
    onEndLoadingFromJson: EventBase<SurveyModel, Object>;
    /**
     ...
     */
    onCompleting: EventAsync<SurveyModel, CompletingEvent>;
    /**
     ...
     * @see prevPage
     **/
    onCurrentPageChanging: EventAsync<SurveyModel, CurrentPageChangingEvent>;
    /**
     ...
     */
    onCreateRegexValidator: EventBase<SurveyModel, CreateRegexValidatorEvent>;
    /**
    ...
    */
    ...
    onMatrixRowDragOver: EventBase<SurveyModel, MatrixRowDragOverEvent>;
    /**
     ...
     */
    onExpressionRunning: EventBase<SurveyModel, ExpressionRunningEvent>;
    /**
    ...
    */
     ...
     * [View Demo](https://surveyjs.io/form-library/examples/save-and-restore-user-responses-to-complete-survey/ (linkStyle))
     */
    onUIStateChanged: EventBase<SurveyModel, UIStateChangedEvent>;
    /**
    ...
    onCheckSingleInputPerPageMode: EventBase<SurveyModel, CheckSingleInputPerPageModeEvent>;
    onGetLoopQuestions: EventBase<SurveyModel, GetLoopQuestionsEvent>;
    /**
     ...
     */
    onCreateCustomChoiceItem: EventBase<SurveyModel, CreateCustomChoiceItemEvent>;
    constructor(jsonObj?: any, renderedElement?: any);
    protected onPropertyValueChanged(name: string, oldValue: any, newValue: any): void;
    private currentPageUpdateElementCss;
    private tocModelValue;
    private get tocModel();
    ...
    private getOrCreateHtmlLocString;
    /**
    ...
    getRendererForString(element: Question | PanelModel | PageModel | SurveyModel, name: string, item?: ItemValue): string;
    ...
    get locEmptySurveyText(): LocalizableString;
    /**
    ...
    createNavigationBarCallback: () => ActionContainer;
    ...
    */
    ...
    private _updateNavigationItemCssCallback;
     ...
     */
    get uiState(): ISurveyUIState;
    set uiState(state: ISurveyUIState);
    private isSettingDataValue;
     ...
     * | `"inputPerPage"` | Question |
     */
    get currentElement(): ISurveyElement;
    set currentElement(val: ISurveyElement);
    /**
    ...
    private get isNavigationBlocked();
    private set isNavigationBlocked(value);
    private currentPageChanging;
    ...
    nextPage(): boolean;
    performNext(): boolean;
    private performNextAfterValidation;
    performPrevious(): boolean;
    private validateOnNavigate;
    ...
    private getNewName;
    private validateActivePage;
    private validatePageCore;
    ...
    get isSingleVisibleInput(): boolean;
    ...
    private setupSingleInputNavigationActions;
     ...
     */
    doComplete(isCompleteOnTrigger?: boolean, completeTrigger?: Trigger): boolean | undefined;
    ...
    private lastActiveQuestionValue;
    private get lastActiveQuestion();
    private set lastActiveQuestion(value);
     ...
     * @see downloadFile
     */
    uploadFiles(question: QuestionFileModel | QuestionSignaturePadModel, name: string, files: File[], callback: (data: any | Array<any>, errors?: any | Array<any>) => any, sourceType?: string): void;
    ...
    private validateQuestionOnValueChanged;
    private validateQuestionOnValueChangedCore;
    private validateOnValueChanging;
    ...
    private reportWarningOnUsingService;
     ...
     */
    mergeLocalizationJSON(json: any, locales?: Array<string>): void;
     ...
     * @see getValue
     */
    setValue(name: string, newQuestionValue: any, locNotification?: boolean | "text", allowNotifyValueChanged?: boolean, questionName?: string): void;
     ...
     * @see getComment
     */
    setComment(name: string, newValue: string, locNotification?: boolean | "text"): void;
    /**
    ...
    */
    ...
    private isMovingPage;
    startMovingPage(): void;
    stopMovingPage(): void;
    ...
    private get layoutElements();
    private createLayoutElements;
    /**
    ...
    getContainerContent(container: LayoutElementContainer): Array<ISurveyLayoutElement>;
    ...
    get rootScrollDisabled(): boolean;
    get formScrollDisabled(): boolean;
    onScroll(): void;
