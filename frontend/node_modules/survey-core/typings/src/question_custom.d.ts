...
import { ISurveyImpl, ISurveyData, ISurvey, ITextProcessor, IPanel, IElement, IQuestion, IProgressInfo } from "./base-interfaces";
...
export declare class ComponentQuestionJSON {
    ...
    getNumberQuestionsWithHiddenTitle(res: boolean): boolean;
...
export declare abstract class QuestionCustomModelBase extends Question implements ISurveyImpl, ISurveyData, IPanel {
    ...
    private isLoadedCalled;
    private onCustomQuestionLoaded;
    onSurveyLoad(): void;
    setSurveyCore(value: ISurvey): void;
...
export declare class CompositeValueGetterContext extends QuestionValueGetterContext {
