...
export declare function glc(index: number): any;
...
export { CustomError, AnswerRequiredError, OneAnswerRequiredError, RequreNumericError, ExceedSizeError, ExceedFilesCountError } from "../../src/error";
...
export { MatrixRowModel, MatrixCells, QuestionMatrixModel, MatrixColumn, IMatrixData } from "../../src/question_matrix";
...
export { QuestionCheckboxBase, QuestionSelectBase, ChoiceItem } from "../../src/question_baseselect";
