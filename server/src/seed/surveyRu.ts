export const surveyJsonRu = {
    ...
    pages: [
            ...
            elements: [
                {
                    ...
                    placeholder: " отдел",
                    choices: [
                        "Отдел кардиохирургии с реабилитацией",
                        "Отдел интервенционной кардиологии № 1",
                        "Отдел интервенционной кардиологии № 2",
                        "Отдел гинекологии",
                        "Отдел аритмологии",
                        "Отдел терапии №2",
                        "Отдел общей и торакальной хирургии",
                        "Отдел нейрохирургии",
                        "Отдел урологии",
                        "Детский кардиохирургический центр",
                    ],
                },
                {
                    type: "radiogroup",
        ...
        {
            title:
                "Оцените качество работы в отделе , где вы получаете обследование и лечение ",
            elements: [
                {
                    type: "rating",
                    name: "Лечащего врача",
            ...
            elements: [
                {
                    ...
                    title:
                        "Удовлетворены ли Вы вежливостью и внимательностью Врача",
                    isRequired: true,
                    autoGenerate: false,
                    rateCount: 10,
                    defaultValue: 10,
                ...
                },
                {
                    ...
                    title:
                        "Удовлетворены ли Вы вежливостью и внимательностью Медсестры",
                    isRequired: true,
                    autoGenerate: false,
                    rateCount: 10,
                    defaultValue: 10,
                ...
                },
                {
                    ...
                    title:
                        "Насколько Вы удовлетворены полнотой информирования перед операцией, манипуляциями, процедурами",
                    isRequired: true,
                    autoGenerate: false,
                    rateCount: 10,
                    defaultValue: 10,
                ...
                },
                {
                    ...
                    title:
                        "Оцените качество и полноту рекомендации врача при выписке",
                    isRequired: true,
                    autoGenerate: false,
                    rateCount: 10,
                    defaultValue: 10,
                ...
                },
                {
                    ...
                    title:
                        "Оцените сервисные услуги (чистота палаты, киоск, парковка, охрана)",
                    isRequired: true,
                    autoGenerate: false,
                    rateCount: 10,
                    defaultValue: 10,
            ...
            elements: [
                {
                    ...
                    title:
                        "Оцените , насколько Вы готовы рекомендовать нашу клинику",
                    isRequired: true,
                    autoGenerate: false,
                    rateCount: 10,
                    defaultValue: 10,
                ...
                },
                {
                    ...
                    title:
                        "Оцените , насколько Вы готовы рекомендовать нашу клинику вашим друзьям и знакомым",
                    isRequired: true,
                    autoGenerate: false,
                    rateCount: 10,
                    defaultValue: 10,
                ...
                },
                {
                    ...
                    title:
                        "Оцените, насколько Вы предпочли бы повторно обратиться в нашу клинику при необходимости обследования и лечения",
                    isRequired: true,
                    autoGenerate: false,
                    rateCount: 10,
                    defaultValue: 10,
                ...
                },
                {
                    ...
                    title:
                        "Как Вы оцениваете соблюдение правил безопасности для Вашего здоровья при проведении процедур",
                    isRequired: true,
                    autoGenerate: false,
                    rateCount: 10,
                    defaultValue: 10,
        ...
        },
        {
            elements: [
                ...
                },
                {
                    ...
                    title:
                        "Соблюдается ли конфиденциальность во время осмотра / процедура ",
                    isRequired: true,
                    colCount: 3,
                    choices: ["Да", "Нет", "Затрудняюсь ответить"],
                    defaultValue: "Да",
                ...
                },
                {
                    ...
                    title:
                        "Мыл ли медицинский работник руки перед Вашим осмотром , манипуляцией , контактом ? ",
                    isRequired: true,
                    colCount: 3,
                    choices: ["Да", "Нет", "Затрудняюсь ответить"],
                    defaultValue: "Да",
                ...
                },
                {
                    ...
                    title:
                        "Приходилось ли Вам приобретать недостающие для лечения лекарственные препараты за счет собсвенных средств ( при лечении по квоте ) ",
                    isRequired: true,
                    colCount: 3,
                    choices: ["Да", "Нет", "Затрудняюсь ответить"],
                    defaultValue: "Нет",
                ...
                },
                {
                    ...
                    title:
                        "Приходилось ли Вам осуществлять оплату медицинские услуги непосредственно медперсоналу, минуя кассу, если да (ФИО сотрудника)",
                    isRequired: true,
                    colCount: 3,
                    choices: ["Да", "Нет", "Затрудняюсь ответить"],
                    defaultValue: "Нет",
                ...
                },
                {
                    ...
                    title:
                        "Была ли предоставлена информация об альтернативных методах лечения?",
                    isRequired: true,
                    colCount: 3,
                    choices: ["Да", "Нет", "Затрудняюсь ответить"],
                    separateSpecialChoices: true,
            ...
            elements: [
                {
                    ...
                    title:
                        "Длительность ожидания в приемном покое при госпитализации (укажите какие)",
                    isRequired: true,
                    colCount: 3,
                    choices: [
                        "Меньше 15 мин",
                ...
                },
                {
                    ...
                    title:
                        " Медицинское обслуживание в этом Центре (подчеркните нужное)",
                    isRequired: true,
                    colCount: 1,
                    choices: [
                ...
                },
                {
                    ...
                    title:
                        "Укажите Ваши замечания, пожелания, предложения по организации работы больницы и повышению качества оказания медицинской помощи:",
                    type: "comment",
                },
            ],
        },
