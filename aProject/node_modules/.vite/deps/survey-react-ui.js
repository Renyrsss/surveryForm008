...
// node_modules/survey-react-ui/fesm/survey-react-ui.js
...
var SurveyAction = class extends SurveyElementBase {
  ...
  renderElement() {
    ...
    return React.createElement(
      "div",
      { className: itemClass, id: this.item.id, ref: this.ref },
      React.createElement(
        "div",
...
var TitleElement = class extends React.Component {
  ...
  render() {
    ...
    const titleContent = React.createElement(TitleActions, { element, cssClasses: element.cssClasses });
    let onClick = void 0;
    let onKeyUp = void 0;
...
var SurveyQuestionOtherValueItem = class extends SurveyQuestionCommentItem {
  getTextAreaModel() {
...
var SurveyQuestion = class _SurveyQuestion extends SurveyElementBase {
  ...
  renderQuestionContent() {
    ...
    var errorsTop = this.question.showErrorOnTop ? this.renderErrors(cssClasses, "top") : null;
    var errorsBottom = this.question.showErrorOnBottom ? this.renderErrors(cssClasses, "bottom") : null;
    ...
    return React.createElement(
      "div",
      { className: question.cssContent || void 0, style: contentStyle, role: "presentation" },
      errorsTop,
      questionRender,
      comment,
      errorsBottom,
  ...
  renderElement() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { ref: this.rootRef, id: question.id, className: question.getRootCss(), style: rootStyle, role: question.ariaRole, "aria-required": this.question.ariaRequired, "aria-invalid": this.question.ariaInvalid, "aria-labelledby": question.ariaLabelledBy, "aria-describedby": question.ariaDescribedBy, "aria-expanded": question.ariaExpanded, "data-name": question.name },
        errorsAboveQuestion,
        headerTop,
        questionContent,
        headerBottom,
  ...
  renderComment(cssClasses) {
    ...
    return React.createElement(
      ...
      React.createElement(SurveyQuestionCommentItem, { question: this.question, cssClasses, otherCss: cssClasses.other, isDisplayMode: this.question.isInputReadOnly })
    );
  }
...
var Survey = class extends SurveyElementBase {
  ...
  renderPage(page) {
    return React.createElement(SurveyPage, { survey: this.survey, page, css: this.css, creator: this });
  }
  renderEmptySurvey() {
...
var SurveyPanel = class extends SurveyPanelBase {
  ...
  renderContent(style, rows, className) {
    ...
    return React.createElement(
      "div",
      { style, className, id: this.panel.contentId },
      rows,
      bottom
    );
  }
...
var SurveyQuestionCheckbox = class extends SurveyQuestionElementBase {
  constructor(props) {
    super(props);
  }
  get question() {
  ...
  renderOther() {
    ...
    return React.createElement(
      ...
      React.createElement(SurveyQuestionOtherValueItem, { question: this.question, otherCss: cssClasses.other, cssClasses, isDisplayMode: this.isDisplayMode })
    );
  }
...
var SurveyQuestionCheckboxItem = class extends ReactSurveyElement {
  constructor(props) {
    super(props);
...
var SurveyQuestionRanking = class extends SurveyQuestionElementBase {
  ...
  renderItem(item, i, handleKeydown, handlePointerDown, handlePointerUp, cssClasses, itemClass, question, unrankedItem) {
    ...
    const renderedItem = React.createElement(SurveyQuestionRankingItem, { key: item.value, text, index, indexText, itemTabIndex: tabIndex, handleKeydown, handlePointerDown, handlePointerUp, cssClasses, itemClass, question, unrankedItem, item });
    const survey = this.question.survey;
    let wrappedItem = null;
    if (!!survey) {
      wrappedItem = ReactSurveyElementsWrapper.wrapItemValue(survey, renderedItem, this.question, item);
...
var SurveyQuestionRankingItem = class extends ReactSurveyElement {
  ...
  renderElement() {
    ...
    return React.createElement(
      "div",
      { tabIndex: this.itemTabIndex, className: this.itemClass, onKeyDown: this.handleKeydown, onPointerDown: this.handlePointerDown, onPointerUp: this.handlePointerUp, "data-sv-drop-target-ranking-item": this.index },
      React.createElement(
        "div",
...
var RatingItem = class extends RatingItemBase {
  render() {
    ...
    return React.createElement(
      "label",
      { onMouseDown: this.handleOnMouseDown, className: this.question.getItemClassByText(this.item.itemValue, this.item.text) },
      ...
      }, "aria-required": this.question.ariaRequired, "aria-label": this.question.ariaLabel, "aria-invalid": this.question.ariaInvalid, "aria-errormessage": this.question.ariaErrormessage }),
...
var RatingItemStar = class extends RatingItemBase {
  render() {
    return React.createElement(
      "label",
      { onMouseDown: this.handleOnMouseDown, className: this.question.getItemClass(this.item.itemValue), onMouseOver: (e) => this.question.onItemMouseIn(this.item), onMouseOut: (e) => this.question.onItemMouseOut(this.item) },
      React.createElement("input", { type: "radio", className: "sv-visuallyhidden", name: this.question.questionName, id: this.question.getInputId(this.index), value: this.item.value, disabled: this.question.isDisabledAttr, readOnly: this.question.isReadOnlyAttr, checked: this.question.value == this.item.value, onClick: this.props.handleOnClick, onChange: () => {
      }, "aria-required": this.question.ariaRequired, "aria-label": this.question.ariaLabel, "aria-invalid": this.question.ariaInvalid, "aria-errormessage": this.question.ariaErrormessage }),
...
var RatingItemSmiley = class extends RatingItemBase {
  render() {
    return React.createElement(
      "label",
      { onMouseDown: this.handleOnMouseDown, style: this.question.getItemStyle(this.item.itemValue, this.item.highlight), className: this.question.getItemClass(this.item.itemValue), onMouseOver: (e) => this.question.onItemMouseIn(this.item), onMouseOut: (e) => this.question.onItemMouseOut(this.item) },
      React.createElement("input", { type: "radio", className: "sv-visuallyhidden", name: this.question.questionName, id: this.question.getInputId(this.index), value: this.item.value, disabled: this.question.isDisabledAttr, readOnly: this.question.isReadOnlyAttr, checked: this.question.value == this.item.value, onClick: this.props.handleOnClick, onChange: () => {
      }, "aria-required": this.question.ariaRequired, "aria-label": this.question.ariaLabel, "aria-invalid": this.question.ariaInvalid, "aria-errormessage": this.question.ariaErrormessage }),
  ...
  render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("input", { type: "text", autoComplete: "off", id: this.question.getInputId(), inputMode: this.model.inputMode, ref: (element) => this.inputElement = element, className: this.question.cssClasses.filterStringInput, disabled: this.question.isInputReadOnly, readOnly: this.model.filterReadOnly ? true : void 0, size: !this.model.inputStringRendered ? 1 : void 0, role: this.model.filterStringEnabled ? this.question.ariaRole : void 0, "aria-expanded": this.question.ariaExpanded, "aria-label": this.question.a11y_input_ariaLabel, "aria-labelledby": this.question.a11y_input_ariaLabelledBy, "aria-describedby": this.question.a11y_input_ariaDescribedBy, "aria-controls": this.model.listElementId, "aria-activedescendant": this.model.ariaActivedescendant, placeholder: this.model.filterStringPlaceholder, onKeyDown: (e) => {
          this.keyhandler(e);
        }, onChange: (e) => {
          this.onChange(e);
        }, onBlur: (e) => {
...
var SurveyQuestionDropdownBase = class extends SurveyQuestionUncontrolledElement {
  ...
  renderSelect(cssClasses) {
    ...
    if (this.question.isReadOnly) {
      ...
      selectElement = React.createElement(
        "div",
        { id: this.question.inputId, "aria-label": this.question.a11y_input_ariaLabel, "aria-labelledby": this.question.a11y_input_ariaLabelledBy, "aria-describedby": this.question.a11y_input_ariaDescribedBy, tabIndex: this.question.isDisabledAttr ? void 0 : 0, className: this.question.getControlClass(), ref: (div) => this.setControl(div) },
        text,
    ...
    return React.createElement(
      "div",
      { className: cssClasses.selectWrapper, onClick: this.click },
      selectElement,
  ...
  createClearButton() {
    ...
    return React.createElement(
      "div",
      { className: this.question.cssClasses.cleanButton, style, onClick: this.clear, "aria-hidden": "true" },
  ...
  renderOther(cssClasses) {
    return React.createElement(
      "div",
      { className: this.question.getCommentAreaCss(true) },
      React.createElement(SurveyQuestionOtherValueItem, { question: this.question, otherCss: cssClasses.other, cssClasses, isDisplayMode: this.isDisplayMode, isOther: true })
    );
  }
  componentDidUpdate(prevProps, prevState) {
    super.componentDidUpdate(prevProps, prevState);
...
var SurveyQuestionDropdownSelect = class extends SurveyQuestionDropdown {
  ...
  renderSelect(cssClasses) {
    ...
    const selectElement = this.isDisplayMode ? (
      ...
      this.question.visibleChoices.map((item, i) => React.createElement(SurveyQuestionOptionItem, { key: "item" + i, item }))
    );
    return React.createElement(
      "div",
...
var SurveyQuestionMatrix = class extends SurveyQuestionElementBase {
  ...
  renderElement() {
    ...
    for (var i = 0; i < this.question.visibleColumns.length; i++) {
      ...
      headers.push(React.createElement("th", { className: this.question.cssClasses.headerCell, style, key }, this.wrapCell({ column }, columText, "column-header")));
    }
    var rows = [];
    ...
    for (var i = 0; i < visibleRows.length; i++) {
      ...
      rows.push(React.createElement(SurveyQuestionMatrixRow, { key, question: this.question, cssClasses, row, isFirst: i == 0 }));
    }
    ...
    return React.createElement(
      "div",
      { className: cssClasses.tableWrapper, ref: (root) => this.setControl(root) },
      React.createElement(
        "fieldset",
        null,
        React.createElement("legend", { className: "sv-hidden" }, this.question.locTitle.renderedHtml),
...
var SurveyQuestionMatrixCell = class extends ReactSurveyElement {
  ...
  renderElement() {
    ...
    return React.createElement(
      ...
      React.createElement("span", { className: this.question.cssClasses.materialDecorator }, this.question.itemSvgIcon ? React.createElement(
        "svg",
        { className: this.cssClasses.itemDecorator },
        React.createElement("use", { xlinkHref: this.question.itemSvgIcon })
      ) : null),
...
var SurveyQuestionFile = class extends SurveyQuestionElementBase {
  ...
  renderClearButton(className) {
    return !this.question.isUploading ? React.createElement(
      "button",
      { type: "button", onClick: this.question.doClean, className },
      React.createElement("span", null, this.question.clearButtonCaption),
      !!this.question.cssClasses.removeButtonIconId ? React.createElement(SvgIcon, { iconName: this.question.cssClasses.removeButtonIconId, size: "auto", title: this.question.clearButtonCaption }) : null
    ) : null;
  }
  renderPreview() {
...
var SurveyFilePage = class extends SurveyElementBase {
  ...
  renderElement() {
    const items = this.page.items.map((item, index) => {
      return React.createElement(SurveyFileItem, { item, question: this.question, key: index });
    });
...
var SurveyFilePreview = class extends SurveyElementBase {
  ...
  renderElement() {
    const content = this.question.supportFileNavigator ? this.question.renderedPages.map((page, index) => {
      return React.createElement(SurveyFilePage, { page, question: this.question, key: page.id });
    }) : this.question.previewValue.map((item, index) => {
      return React.createElement(SurveyFileItem, { item, question: this.question, key: index });
    });
...
var SurveyQuestionRadiogroup = class extends SurveyQuestionElementBase {
  constructor(props) {
    super(props);
  }
  get question() {
...
var SurveyQuestionRadioItem = class extends ReactSurveyElement {
  constructor(props) {
    super(props);
    this.rootRef = React.createRef();
    this.handleOnChange = this.handleOnChange.bind(this);
  ...
  */
  ...
  renderElement() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "label",
        { className: itemClass, onClick: this.handleOnClick },
...
var SurveyQuestionMatrixDropdownBase = class extends SurveyQuestionElementBase {
  ...
  renderTableDiv() {
    var divStyle = this.question.showHorizontalScroll ? { overflowX: "scroll" } : {};
    return React.createElement(
      "div",
      { style: divStyle, className: this.question.cssClasses.tableWrapper, ref: (root) => this.setControl(root) },
...
var SurveyQuestionMatrixDropdownCell = class extends SurveyQuestionAndErrorsCell {
  ...
  renderOtherComment() {
    ...
    return React.createElement(SurveyQuestionOtherValueItem, { question, cssClasses, otherCss: cssClasses.other, isDisplayMode: question.isInputReadOnly });
  }
  renderCellCheckboxButton() {
    var key = this.cell.question.id + "item" + this.cell.choiceIndex;
    return React.createElement(SurveyQuestionCheckboxItem, { key, question: this.cell.question, cssClasses: this.cell.question.cssClasses, isDisplayMode: this.cell.question.isInputReadOnly, item: this.cell.item, isFirst: this.cell.isFirstChoice, index: this.cell.choiceIndex.toString(), hideCaption: true });
  }
  renderCellRadiogroupButton() {
    var key = this.cell.question.id + "item" + this.cell.choiceIndex;
    return React.createElement(SurveyQuestionRadioItem, { key, question: this.cell.question, cssClasses: this.cell.question.cssClasses, isDisplayMode: this.cell.question.isInputReadOnly, item: this.cell.item, index: this.cell.choiceIndex.toString(), isChecked: this.cell.question.value === this.cell.item.value, isDisabled: this.cell.question.isReadOnly || !this.cell.item.isEnabled, hideCaption: true });
  }
};
...
var SurveyQuestionMatrixDynamic = class extends SurveyQuestionMatrixDropdownBase {
  ...
  renderNoRowsContent(cssClasses) {
    ...
    const btn = this.matrix.renderedTable.showAddRow ? this.renderAddRowButton(cssClasses, true) : void 0;
    return React.createElement(
      "div",
...
var SurveyQuestionPanelDynamic = class extends SurveyQuestionElementBase {
  ...
  renderElement() {
    ...
    this.question.renderedPanels.forEach((panel, index) => {
      panels.push(React.createElement(SurveyQuestionPanelDynamicItem, { key: panel.id, element: panel, question: this.question, index, cssClasses: this.question.cssClasses, isDisplayMode: this.isDisplayMode, creator: this.creator }));
    });
    const btnAdd = this.question.isRenderModeList && this.question["showLegacyNavigation"] ? this.renderAddRowButton() : null;
    const navTop = this.question.isProgressTopShowing ? this.renderNavigator() : null;
    const navBottom = this.question.isProgressBottomShowing ? this.renderNavigator() : null;
  ...
  renderNavigator() {
    ...
    const progressClass = this.question.isProgressTopShowing ? this.question.cssClasses.progressTop : this.question.cssClasses.progressBottom;
    return React.createElement(
      "div",
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: this.question.cssClasses.progressContainer },
          btnPrev,
          range,
          btnNext
        ),
  ...
  renderNavigatorV2() {
    ...
    return React.createElement(
      ...
      range,
      this.question.footerToolbar.visibleActions.length ? React.createElement(
        "div",
  ...
  renderPlaceholder() {
    if (this.question.getShowNoEntriesPlaceholder()) {
      return React.createElement(
        "div",
        { className: this.question.cssClasses.noEntriesPlaceholder },
...
var SurveyProgress = class extends SurveyNavigationBase {
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { style: progressStyle, className: this.css.progressBar, role: "progressbar", "aria-valuemin": 0, "aria-valuemax": 100, "aria-label": "progress" },
...
var SurveyProgressButtons = class extends SurveyNavigationBase {
  ...
  render() {
    return React.createElement(
      "div",
      { className: this.model.getRootCss(this.props.container), style: { "maxWidth": this.model.progressWidth }, role: "progressbar", "aria-valuemin": 0, "aria-valuemax": 100, "aria-label": "progress" },
...
var ListItem = class extends SurveyElementBase {
  ...
  render() {
    ...
    const contentWrap = React.createElement("div", { style: this.model.getItemStyle(this.item), className: this.model.cssClasses.itemBody, title: this.item.getTooltip(), onMouseOver: (event) => {
    ...
    return attachKey2click(React.createElement(
      "li",
      { className, role: "option", style, id: this.item.elementId, "aria-selected": this.model.isItemSelected(this.item), onClick: (event) => {
...
var SurveyQuestionImagePicker = class extends SurveyQuestionElementBase {
  ...
  renderItem(key, item, cssClasses) {
    const renderedItem = React.createElement(SurveyQuestionImagePickerItem, { key, question: this.question, item, cssClasses });
    const survey = this.question.survey;
    let wrappedItem = null;
    if (!!survey) {
      wrappedItem = ReactSurveyElementsWrapper.wrapItemValue(survey, renderedItem, this.question, item);
...
var SurveyQuestionImage = class extends SurveyQuestionElementBase {
  ...
  renderElement() {
    ...
    if (this.question.renderedMode === "image") {
      control = React.createElement("img", {
    ...
    if (this.question.renderedMode === "youtube") {
      control = React.createElement("iframe", { className: cssClasses, src: this.question.locImageLink.renderedHtml, width: this.question.renderedWidth, height: this.question.renderedHeight, style });
    }
    var noImage = null;
    if (!this.question.imageLink || this.question.contentNotLoaded) {
...
var SurveyQuestionMatrixDetailButton = class extends ReactSurveyElement {
  ...
  renderElement() {
    ...
    return React.createElement(
      "button",
      { type: "button", onClick: this.handleOnShowHideClick, className: this.question.getDetailPanelButtonCss(this.row), "aria-expanded": ariaExpanded, "aria-controls": ariaControls },
...
var QuestionErrorComponent = class extends React.Component {
  render() {
    return React.createElement(
      "div",
      null,
      React.createElement("span", { className: this.props.cssClasses.error.icon || void 0, "aria-hidden": "true" }),
      React.createElement(
        "span",
...
survey-react-ui/fesm/survey-react-ui.js:
  (*!
